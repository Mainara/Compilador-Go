 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.Expression1Impl#getUnaryExpr <em>Unary Expr</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.Expression1Impl#getExpression_Linha <em>Expression Linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Expression1Impl extends MinimalEObjectImpl.Container implements Expression1
{
  /**
  ...
  {
    return MyDslPackage.Literals.EXPRESSION1;
  }
  ...
  public NotificationChain basicSetUnaryExpr(UnaryExpr newUnaryExpr, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION1__UNARY_EXPR, oldUnaryExpr, newUnaryExpr);
  ...
  public void setUnaryExpr(UnaryExpr newUnaryExpr)
  {
    if (newUnaryExpr != unaryExpr)
    {
      ...
      if (unaryExpr != null)
        msgs = ((InternalEObject)unaryExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION1__UNARY_EXPR, null, msgs);
      if (newUnaryExpr != null)
        msgs = ((InternalEObject)newUnaryExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION1__UNARY_EXPR, null, msgs);
      msgs = basicSetUnaryExpr(newUnaryExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION1__UNARY_EXPR, newUnaryExpr, newUnaryExpr));
  }
  ...
  public NotificationChain basicSetExpression_Linha(Expression_Linha newExpression_Linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION1__EXPRESSION_LINHA, oldExpression_Linha, newExpression_Linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExpression_Linha(Expression_Linha newExpression_Linha)
  {
    if (newExpression_Linha != expression_Linha)
    {
      ...
      if (expression_Linha != null)
        msgs = ((InternalEObject)expression_Linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION1__EXPRESSION_LINHA, null, msgs);
      if (newExpression_Linha != null)
        msgs = ((InternalEObject)newExpression_Linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION1__EXPRESSION_LINHA, null, msgs);
      msgs = basicSetExpression_Linha(newExpression_Linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION1__EXPRESSION_LINHA, newExpression_Linha, newExpression_Linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.EXPRESSION1__UNARY_EXPR:
        return basicSetUnaryExpr(null, msgs);
      case MyDslPackage.EXPRESSION1__EXPRESSION_LINHA:
